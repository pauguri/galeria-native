export default function WheatIcon({ color = 'currentColor', size }: { color?: string, size: number }) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" width={size} height={size} fill={color}>
            <path
